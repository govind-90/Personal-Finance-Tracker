...
//   return (
//     <>
//     <Modal title="Add Income" style={{fontWeight:600}} visible={isIncomeModalVisible} onCancel={handleIncomeCancel} footer={null}>
...
//    </Form.Item>
//    <Form.Item 
//    style={{fontWeight:600}} label="Tag" name="tag"rules={[
//     {
//         required:true,
